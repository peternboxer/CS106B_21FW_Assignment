...
void drawSierpinskiTriangle(GWindow& window,
    ...
    /* recursive while order >0 */
    else
    {
        order--;
        drawSierpinskiTriangle(window, x0, y0,(x0+x1)/2, (y0+y1)/2, (x0+x2)/2, (y0+y2)/2,order );
        drawSierpinskiTriangle(window, x1, y1,(x0+x1)/2, (y0+y1)/2, (x1+x2)/2, (y1+y2)/2,order );
        drawSierpinskiTriangle(window, x2, y2,(x2+x1)/2, (y2+y1)/2, (x0+x2)/2, (y0+y2)/2,order );
    }
}
